              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div
                      class="form-group bmd-form-group"
                      :class="{
                      'has-items': entry.products_count,
                      'is-focused': activeField == 'products_count'
                    }"
                  >
                    <label class="bmd-label-floating required">{{
                        $t('cruds.product.fields.products_count')
                      }}</label>
                    <input
                        class="form-control"
                        type="number"
                        step="1"
                        :value="entry.products_count"
                        @input="updateProductsCount"
                        @focus="focusField('products_count')"
                        @blur="clearFocus"
                        required
                    />
                  </div>
...
export default {
  ...
  methods: {
    ...
    updateProductsCount(e) {
      this.setProductsCount(e.target.value)
    },
    getRoute(name) {
